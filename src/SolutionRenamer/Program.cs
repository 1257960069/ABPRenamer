...
namespace SolutionRenamer
{
	static class Program
    {
        static void Main(string[] args)
        {
            ...
            var fileExtensions = ".cs,.cshtml,.js,.ts,.csproj,.sln,.xml,.config";

            string[] filter = fileExtensions.Split(',');

			Console.WriteLine();
			Console.WriteLine("Input your company name(默认:MyCompanyName):");
            ...
            Console.WriteLine("Input your peoject name(默认:AbpZeroTemplate):");
			...
			Console.WriteLine("Input your new company name(可空):");
            ...
            Console.WriteLine("Input your new peoject name(必填):");
